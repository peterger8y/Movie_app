...
column1 = dbc.Col(
    [
        dcc.Markdown(
            ...
            the linear model was nearly as accurate as the decision Tree. I've included the coefficients for this model, as I think these metrics are
            more difficult to misinterpret than PDP's. ->
